...
# # Equations for an Armington trade focused partial equilibrium model
# # Solve the model using nleqslv
# # Process output and return output database
# # Calculate GoF for hindcast scenarios
# # Validate model by optimizing parameters
# # Visualize results
#
#
# #Initialize
...
#   model.solve(config = model.shock.config,
#               amessage = T) -> model.sol
...
# all_data <- HISTDATA(SET$SET_YEAR, basedata.allyear)
#
#
